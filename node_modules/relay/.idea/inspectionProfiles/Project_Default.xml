<component name="InspectionProjectProfileManager">
  <profile version="1.0" is_locked="false">
    ...
    <inspection_tool class="BreakStatementJS" enabled="true" level="WEAK WARNING" enabled_by_default="true" />
    ...
    <inspection_tool class="CommaExpressionJS" enabled="true" level="WEAK WARNING" enabled_by_default="true" />
    ...
    <inspection_tool class="ContinueStatementJS" enabled="true" level="WEAK WARNING" enabled_by_default="true" />
    ...
    <inspection_tool class="FallthroughInSwitchStatementJS" enabled="true" level="INFO" enabled_by_default="true" />
    <inspection_tool class="ForLoopThatDoesntUseLoopVariableJS" enabled="true" level="WARNING" enabled_by_default="true" />
    <inspection_tool class="FunctionNamingConventionJS" enabled="true" level="INFO" enabled_by_default="true">
    ...
    <inspection_tool class="JSReferencingMutableVariableFromClosure" enabled="true" level="WEAK WARNING" enabled_by_default="true" />
    ...
    <inspection_tool class="LocalVariableNamingConventionJS" enabled="true" level="INFO" enabled_by_default="true">
    ...
    <inspection_tool class="MagicNumberJS" enabled="true" level="WEAK WARNING" enabled_by_default="true" />
    <inspection_tool class="NestedSwitchStatementJS" enabled="true" level="WARNING" enabled_by_default="true" />
    <inspection_tool class="NestingDepthJS" enabled="true" level="WEAK WARNING" enabled_by_default="true">
      <option name="m_limit" value="5" />
    </inspection_tool>
    <inspection_tool class="NonBlockStatementBodyJS" enabled="true" level="WEAK WARNING" enabled_by_default="true" />
    ...
    <inspection_tool class="OverlyComplexArithmeticExpressionJS" enabled="true" level="WEAK WARNING" enabled_by_default="true">
      <option name="m_limit" value="6" />
    </inspection_tool>
    <inspection_tool class="OverlyComplexBooleanExpressionJS" enabled="true" level="WEAK WARNING" enabled_by_default="true">
      <option name="m_limit" value="4" />
    </inspection_tool>
    <inspection_tool class="ParameterNamingConventionJS" enabled="true" level="INFO" enabled_by_default="true">
      <option name="m_regex" value="[a-z]\w*" />
      <option name="m_minLength" value="1" />
      <option name="m_maxLength" value="32" />
    </inspection_tool>
    <inspection_tool class="ParametersPerFunctionJS" enabled="true" level="INFO" enabled_by_default="true">
      <option name="m_limit" value="6" />
    </inspection_tool>
    ...
    <inspection_tool class="StatementsPerFunctionJS" enabled="true" level="WEAK WARNING" enabled_by_default="true">
    ...
    <inspection_tool class="UnnecessaryLocalVariableJS" enabled="true" level="INFO" enabled_by_default="true">
